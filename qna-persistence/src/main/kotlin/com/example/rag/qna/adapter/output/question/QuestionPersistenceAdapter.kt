...
private fun Question.createEntity() = QuestionEntity(category, title,content, userId, LocalDateTime.now())

private fun QuestionEntity.toDomainModel() = Question(idForTransparency(id), category, title, content, userId, createdAt, updatedAt)
